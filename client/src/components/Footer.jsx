      ...
      <div className="glass backdrop-blur-lg">
        <div className="container mx-auto px-4 py-12">
          <div className="grid md:grid-cols-4 gap-8">
              ...
              <ul className="space-y-3 text-gray-600">
                ...
                <li>
                  <a
                    ...
                    className="hover:text-orange-600 smooth-transition font-light flex items-center gap-2"
                  >
                    <BookMarked className="w-4 h-4" /> Article Reader
                  </a>
                </li>
              </ul>
            </div>
            ...
            {/* Company */}
            <div>
              <h4 className="font-light text-lg text-gray-800 mb-6">Company</h4>
              <ul className="space-y-3 text-gray-600">
                <li>
                  <a
                    href="#"
          ...
          <div className="glass-button border-0 border-t border-gray-300/30 mt-8 pt-8 text-center">
